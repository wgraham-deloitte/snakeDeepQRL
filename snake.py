...
class SnakeGame:
    ...
    def play_frame(self, action, number_of_games):
        self.frame_it += 1
        ...
        if self.is_collision() or self.frame_it > 75*len(self.snake):
            game_over = True
            reward = -10
    ...
    def _move(self, action):
        #boolean[] action = [straight, right, left]
